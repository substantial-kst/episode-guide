  ...
  describe('internal methods', () => {
    ...
    describe('getPageComponent()', () => {
      ...
      describe('returns a component', () => {
        ...
        it(`/ProgramId/browse -> <Browse>`, () => {
          expect(sut(BrowsePageRouteProps)).toStrictEqual(
            <Browse
        ...
        it(`/ProgramId/search -> <Search>`, () => {
          expect(sut(SearchPageRouteProps)).toStrictEqual(
    ...
    describe('getEpisodeFromState()', () => {
      ...
      describe('returns a single Episode from route state', () => {
        it(`Root Path: null`, () => {
          expect(sut(LandingPageRouteProps)).toBeNull()
        })
        it(`/ProgramId/browse -> null`, () => {
          expect(sut(BrowsePageRouteProps)).toBeNull()
        })
        it(`/ProgramId/search -> null`, () => {
          expect(sut(SearchPageRouteProps)).toBeNull()
        })
        it(`/ProgramId/s04e99 -> Fake Episode`, () => {
          expect(sut(DetailPageRouteProps)).toStrictEqual(fakeEpisode)
        })
      })
    })
  })
